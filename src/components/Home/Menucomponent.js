...
function Menucomponent() {
    return (
        <div>
            ...
            <div className='menu2' style={{ backgroundImage: "url(/images/backy2.jpg)" }}>
                        ...
                        <div className="container ">
                            <div className="row specialmenu">
                                <div className="col-md-6 col-sm-12  content">
                                        ...
                                        <p>
                                            Here at images, our focus is on the whole experience
                                ...
                                <div className="col-md-6 col-sm-12 content2">
                                    <figure>
                                        <img src="./images/img13.jpg" alt="" />
                                    </figure>
                                </div>
                                <div div div className="col-md-6 col-sm-12 content2" >
                                    <figure>
                                        <img src="./images/img13.jpg" alt="" />
                                    </figure>
                                </div>
